...
<legend id="titre">Statistiques : Naissance</legend>
    ...
    <a class="btn btn-info" onclick="load_statistique('statistiques.php?param=an')"> Valider </a>
...
$critere = $_GET['critere_select'];
    ...
    foreach($tab_critere as $tab_critere) {
        ...
        if ($critere == "date_naissance") {
            ...
            if (!in_array($val_critere, $xLabel)){
