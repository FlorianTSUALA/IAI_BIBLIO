...
<legend id="titre">Statistiques : Fiche Individuelle Etat Civil</legend>
        ...
        <optgroup>
            ...
            <?php
                $cols = array('sexe'=>'Sexe', 
                              ...
                              'ville_naissance'=>'Lieu de naissance',
    ...
    <a class="btn btn-info" onclick="load_statistique('statistiques.php?param=fiec')"> Valider </a>
...
$critere = $_GET['critere_select'];
    ...
    $tab_critere = Doctrine_Query::create()
                            ...
                            ->from('FicheIndividuelleEtatCivil')
    ...
    foreach($tab_critere as $tab_critere) {
        ...
        if ($critere == "date_naissance") {
            ...
            $req_critere = Doctrine_Query::create()
                    ->select('i.*')
                    ->from('FicheIndividuelleEtatCivil i')
