...
<div style="margin-left: 2%;display: inline-block text-align: center; width: 27%; float: left;padding-top: 10%">
<!--    <img src="../web/images/--><?php //echo $print->logo; ?><!--" width="150" height="200"/> <br />-->
    <strong>ETAT CIVIL</strong>

    <br />________________ <br /><br />

    <span style="font-size: 12px;"><?php if (isset($_GET['print'])) echo utf8_encode("N°: ".$naissance->code); else echo "N?: ".$naissance->code; ?><br />
    <?php echo " du ".format_date_fr($naissance->date_etablissement); ?>

    du r&eacute;gistre</span>
...
<div style="text-align: center; ">
    <img src="../web/images/<?php echo $print->logo; ?>" width="150" height="200"/> <br /><br />
    <h3>EXTRAIT</h3>
