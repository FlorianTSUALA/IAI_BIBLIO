...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Debut",sLast:"Fin",sNext:"Suivant",sPrevious:"Precedent"},
sEmptyTable:"Aucune ligne trouvee dans la table",sInfo:"Affichez _START_ a _END_ sur _TOTAL_ lignes",sInfoEmpty:"Affichez 0 a 0 sur 0 lignes",sInfoFiltered:"(filtre sur un total de _MAX_ lignes)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affichez _MENU_ lignes",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune ligne trouvee"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
