...
<head>
  ...
  <link href="../template/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
</head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin bibliotheque</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Stéphane Tadjou</a>
        </div>
      </div>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/UI/general.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter un nouveau cycle</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/UI/icons.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Liste des cycles disponible</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
		...
		<table class="table">
			<tr>
				...
				<td><input type="text" name="cycle" required="" class="form-control"/></td>
			</tr>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="../template/http://adminlte.io">IAI</a>.</strong>
    All rights reserved.
